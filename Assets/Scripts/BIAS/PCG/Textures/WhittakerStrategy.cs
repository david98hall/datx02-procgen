...
namespace BIAS.PCG.Textures
{
    ...
    /// </summary>
    internal class WhittakerStrategy : Strategy<float[,], Texture2D>
    {
        ...
        /// </summary>
        internal WhittakerStrategy([NotNull] IInjector<float[,]> heightMapInjector) : base(heightMapInjector)
        {
        }
