...
public class LSystem
{
                        ...
                        switch(c)
                        {
                            ...
                            case 'B':{
                                ...
                                if(intersects <= 1){
                                    ...
                                    row2.AddLast(state.pos + length * splitDir);
                                    row2.AddLast(state.pos + length * splitDir + length*rotate90);
    ...
    /// </summary>
    /// <param name="s">The initial state of the grid, containing position and direction.</param>
    /// <returns></returns>
    private State Grid(State s){
